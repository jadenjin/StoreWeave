...
final class InMemoryFtpConnectionFactory implements FtpConnectionFactory {
    ...
    private final class MemorySession implements Session {
        ...
        public void deleteDirectory(String path) throws IOException {
            ...
            if (directories.stream().anyMatch(item -> item.startsWith(descendant))
                ...
                throw new CommonsNetFtpConnectionFactory.FtpConflictException("Directory is not empty");
            }
